...
disp(manifImgnm(sortId(1:3)))
fprintf("Bottom N Manifold image: " );
disp(manifImgnm(sortId(end-1:end)))
...
disp(EStats(Expi).ref.imgnm(sortId(1:3)))
fprintf("Bottom N natural reference image: " );
disp(EStats(Expi).ref.imgnm(sortId(end-1:end)))
end
...
disp(pasuimgnm(sortId(1:3)))
fprintf("Bottom N Pasupathy image: " );
disp(pasuimgnm(sortId(end-1:end)))
end
% Gabor patches
