function [meta_new,rasters_new,lfps_new,Trials_new] = LoadRaw_and_Append_Coll(rowi, meta_new,rasters_new,lfps_new,Trials_new)
% Keep the content of meta_new and append new trials to it. 
% Functional version of Append_Exp_to_Collection.m script
[meta_new2,rasters_new2,lfps_new2,Trials_new2] = Project_Manifold_Beto_loadRaw(rowi);
