...
function CosStats = Evol_PCCosine_Collect_Stats_fun(meta_new, rasters_new, Trials_new)
...
CosStats(iTr).score.offline_vec = scorePopulationVec_direction(evkbsl_trials, ...
...
CosStats(iTr).score.(dist_fun+"_"+area) = scorePopulationVec_direction(evkbsl_trials, ...
