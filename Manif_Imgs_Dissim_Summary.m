...
for mi = 1:numel(metric_list) % Loop through different distance metrics
	...
	[R2, slope, intercept] = Linearfitting(evoref_dist_vec, evoref_vec);
...
for mi = 1:numel(metric_list)
	...
	[R2, slope, intercept] = Linearfitting(pasu_dist_vec, pasu_vec);
...
for mi = 1:numel(metric_list)
	...
	[R2, slope, intercept] = Linearfitting(gab_dist_vec, gab_vec);
