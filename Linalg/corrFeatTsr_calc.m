...
%% Figure out the suffix for images
...
%% Correlation Coefficient to each layer of CNN. 
...
% colorbar()
% Save the Mean, Std of Feat, and the corrcoef tensor.
...
%% Formulate Spike and image name data 
...
%%  online calculation of mean and Sq to compute Correlation. Use Bsz as batch 
...
%%
%% Correct the stimuli storage location for EStats and Stats.
if Animal == "Alfa"
