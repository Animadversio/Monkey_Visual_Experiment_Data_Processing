...
guidata(figh, data);
TheSLD = uicontrol(figh, 'Style', "slider", 'Position', [600 30 250 10], "String", "Norm", ...
            'Value', 0, "Callback", @(src, evt) ThetaSlider_Callback(src, evt));
TheSLD.Min = -pi/2; TheSLD.Max = pi/2;TheSLD.SliderStep = [0.005 0.05];
PhiSLD = uicontrol(figh, 'Style', "slider", 'Position', [600 5 250 10], "String", "Norm", ...
...
CT = uicontrol(figh, 'Style', 'pushbutton', 'Position', [20 40 60 40], "String", "Set Image",...
