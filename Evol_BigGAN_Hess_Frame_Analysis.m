...
fprintf("For %d BigGAN Evolution Experiment, we collect the mean last generation gene, and project\n"+...
    ...
    "[i.e. correlation with the eigenIdx (%.3f) eigenvalue (%.3f) and log(eigenvalue) (%.3f)\n",...
    size(last_gen_mean_proj,1), cc_idx, cc_eva, cc_logeva, cc_idx_shfl, cc_eva_shfl, cc_logeva_shfl)
